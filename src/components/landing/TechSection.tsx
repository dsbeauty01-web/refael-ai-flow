    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8" ref={ref}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="font-hebrew text-3xl sm:text-4xl font-bold mt-3 mb-2">מה מתחת למכסה</h2>
          <p className="text-muted-foreground">What Powers These Bots</p>
        </div>
        ...
        >
          {/* Left: RAG explanation */}
          <div dir="rtl">
            <h3 className="font-hebrew text-xl font-bold mb-3">מה זה RAG?</h3>
            <p className="font-hebrew text-sm text-muted-foreground leading-relaxed mb-2">
              טכנולוגיה שמאפשרת לבוט לחפש מידע אמיתי מהעסק שלך ולענות בדיוק.
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed mb-6" dir="ltr">
            ...
            <div className="bg-secondary/50 rounded-2xl p-5 border border-border">
              <p className="font-hebrew text-sm leading-relaxed mb-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {techStack.map((t, i) => (
              <div
                key={i}
                className="bg-card rounded-xl p-4 border border-border card-lift text-center"
              >
